...
public class EditActivity extends AppCompatActivity implements  ProgressRequestBody.UploadCallbacks{
    ...
    private void editUser() {
        ...
        if (prf.getString("LOGGED").toString().equals("TRUE")) {
            ...
            Call<ApiResponse> call = service.editUser(body,Integer.parseInt(user), key, edit_input_name.getText().toString(), edit_input_email.getText().toString(), edit_input_facebook.getText().toString(), edit_input_twitter.getText().toString(), edit_input_instragram.getText().toString());     call.enqueue(new Callback<ApiResponse>() {
                @Override
